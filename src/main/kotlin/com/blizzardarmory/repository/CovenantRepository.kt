...
interface CovenantRepository : JpaRepository<Covenant, Long> {
    ...
    @Query(value = "select co.id," +
            ...
            nativeQuery = true)
    fun getCovenantClassSpells(@Param("class_id") class_id: Long, @Param("locale") locale: String): List<Covenant>
    ...
    @Query(value = "select co.id," +
            ...
            " left join spell_assets s" +
            "   on s.spell_media_id = sm.spell_id" +
            " where co.playable_class_id is NULL and covenant_id = :cov_id",
            nativeQuery = true)
    fun getCovenantSpells(@Param("cov_id") class_id: Long, @Param("locale") locale: String): List<Covenant>
}